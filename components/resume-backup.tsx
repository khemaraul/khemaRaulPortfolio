  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="text-lg text-[#ec6608] my-[5px]">Masters AI Student at DCU | Data Engineer | Ex ICICI Lombard | Python, Microsoft Azure, Javascript, React.js, Node.js</div>
